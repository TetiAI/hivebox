...
EOF
    # Only write optional config if the user explicitly set them.
    [ -n "${HIVEBOX_OPENCODE_API_KEY:-}" ] && echo "HIVEBOX_OPENCODE_API_KEY=${HIVEBOX_OPENCODE_API_KEY}" >> .env
    [ -n "${HIVEBOX_OPENCODE_BASE_URL:-}" ] && echo "HIVEBOX_OPENCODE_BASE_URL=${HIVEBOX_OPENCODE_BASE_URL}" >> .env
    [ -n "${HIVEBOX_OPENCODE_MODEL:-}" ] && echo "HIVEBOX_OPENCODE_MODEL=${HIVEBOX_OPENCODE_MODEL}" >> .env
    [ -n "${HIVEBOX_OPENCODE_SKILLS_PATH:-}" ] && echo "HIVEBOX_OPENCODE_SKILLS_PATH=${HIVEBOX_OPENCODE_SKILLS_PATH}" >> .env
    ok "Wrote .env"
fi
